...
public class Collection_Class extends Base_Class {
    ...
    public void CoreLogin() throws Exception {
        try {        	
            ...
            String CollectionAppUrl = configloader().getProperty("CollectionApplicationUrl");
            String CollectionUserName = configloader().getProperty("CollectionUserName");
            String CollectionUserPassword = configloader().getProperty("CollectionUserPassword");
            ...
            Common.fluentWait("CollectionUserNameField", LoginPageRepo.CollectionUserNameField);
            Common.fluentWait("CollectionPasswordField", LoginPageRepo.CollectionPasswordField);
            Common.fluentWait("CollectionLoginButton", LoginPageRepo.CollectionLoginButton);
            ...
            String query = "select Default_URL from acc_users where user_id = '"+CollectionUserName+"'";
