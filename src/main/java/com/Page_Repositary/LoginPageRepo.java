...
public class LoginPageRepo {
	...
	public static By CollectionUserNameField = By.xpath("//input[@placeholder='User Name']");
	public static By CollectionPasswordField = By.xpath("//input[@placeholder='Password']");
	public static By CollectionLoginButton = By.xpath("//button[@type='submit']");
