	...
	public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws IOException, InterruptedException {
		...
		try {
			...
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
				...
				ExtentTestManager.startTest("Navigation to User Management Page ");
				...
				ExtentTestManager.startTest("User search page - Default State of 'Is Active' Checkbox");
				
				boolean flag5 = User_UserManagementPage.isIsActiveCheckboxSelected();
				Log.info("IsActive Checkbox Selected by default : " + flag5);
				
				ExtentTestManager.getTest().log(Status.PASS, "'Is Active' checkbox is in selected state by default: " + flag5);
				
				ExtentTestManager.startTest("User search page - Pagination of Active users");
				...
				ExtentTestManager.startTest("User search page - Pagination of Active users - Second page button functionality and data checking ");
				...
				ExtentTestManager.startTest("User search page - Pagination of Active users - Last page button functionality and data checking ");
				...
				ExtentTestManager.startTest("User search page - Pagination of Active users - Previous page button functionality and data checking ");
				...
				ExtentTestManager.startTest("Test Redirect to Add New User Page ");
