...
import com.Pages_UserManagementModule.UserManagement_Page;
...
public class UserManagement_TC extends Base_Class {
	...
	public void User_search_page__Default_State_of_IsActive_Checkbox() throws Throwable {
		try {
			...
			//User_UserManagementPage.isIsActiveCheckboxSelected();
			  ...
			  if (isIsActiveCheckboxSelectedOrNot) {
              Log.info("IsActive Checkbox Selected by default");
              ExtentTestManager.getTest().log(Status.PASS, "IsActive Checkbox Selected by default");
              } else {
                Log.info("IsActive Checkbox is not Selected by default");
                ExtentTestManager.getTest().log(Status.FAIL, "IsActive Checkbox is not Selected by default");
              }
		}catch (AssertionError | Exception e) {
			 String testName = new Object(){}.getClass().getEnclosingMethod().getName(); // Dynamically fetch test method name
	         ExtentTestManager.getTest().log(Status.FAIL, "Test Failed in method: " + testName + " --> " + e.getMessage());
	...
	@Test(priority = 8)
	public void Page_redirects_to_Add_New_User_page_showing_Name_Email_Phone_number_fields_Role_and_Organization_Type_dropdowns_Close_and_Submit_buttons_are_visible() throws Throwable {
		try {
  			    boolean flag14 = User_UserManagementPage.AddNewUserPageElementsDisplayed();
				ExtentTestManager.getTest().log(Status.PASS, "Page redirects to 'Add New User' page showing Name, Email, Phone number fields, Role and Organization Type drop-downs, Close and Submit buttons are visible: " + flag14);
		} catch (AssertionError | Exception e) {
			String testName = new Object(){}.getClass().getEnclosingMethod().getName(); // Dynamically fetch test method name
	        ExtentTestManager.getTest().log(Status.FAIL, "Test Failed in method: " + testName + " --> " + e.getMessage());
	        Log.info("****Test Failed in method: " + testName + " --> " + e.getMessage());
		...
		public void Add_new_user_page_Organization_Type_Selection_as_Head_office_Display_Head_Office_Dropdown(Map<Object,Object> testdata) throws Throwable {
		try {
                ...
                Log.info("Organization Type : " + SelectOrganizationtype);
		...
		public void Add_new_user_page_Organization_Type_Selection_as_Zone_Co_Display_Head_office_and_Zone_CO_dropdown_fields(Map<Object,Object> testdata) throws Throwable {
		try {     
		...
		public void Add_new_user_page_Organization_Type_Selection_as_Region_Display_Head_office_and_Zone_CO_Region_dropdown_fields(Map<Object,Object> testdata) throws Throwable {
		try { 
		...
		public void Add_new_user_page_Organization_Type_Selection_as_Branch_Display_Head_office_and_Zone_CO_Region_and_Branch_dropdown_fields(Map<Object,Object> testdata) throws Throwable {
		try {
		...
		public void Add_new_user_page_Submit_Without_Inputs(Map<Object,Object> testdata) throws Throwable {
		try {
		...
		public void Add_new_user_page_Enter_and_select_inputs_for_all_fields_except_Name_Field_and_click_on_submit_button(Map<Object,Object> testdata) throws Throwable {
		try {	
		        String AddNewUserEmailBtn = testdata.get("Email").toString();
		        String AddNewUserPhoneNumberBtn = testdata.get("Phonenumber").toString();
		        String AddNewUserRole = testdata.get("Testrole").toString();
		...
		public void Add_new_user_page_Enter_and_select_inputs_for_all_fields_except_Email_Field_and_click_on_submit_button(Map<Object,Object> testdata) throws Throwable {
		try {	
		        String AddNewUserNameBtn = testdata.get("Name").toString();
	            String AddNewUserPhoneNumberBtn = testdata.get("Phonenumber").toString();
	            String AddNewUserRole = testdata.get("Testrole").toString();
		...
		public void Add_new_user_page_Enter_and_select_inputs_for_all_fields_except_Phone_number_Field_and_click_on_submit_button(Map<Object,Object> testdata) throws Throwable {
		try {
		        String AddNewUserNameBtn = testdata.get("Name").toString();
	            String AddNewUserEmailBtn = testdata.get("Email").toString();
	            String AddNewUserRole = testdata.get("Testrole").toString();
		...
		public void Add_new_user_page_Enter_and_select_inputs_for_all_fields_except_role_dropdown_and_click_on_submit_button(Map<Object,Object> testdata) throws Throwable {
		try {	
		...
		public void Add_new_user_page_Enter_and_select_inputs_for_all_fields_except_organization_type_dropdown_and_click_on_submit_button(Map<Object,Object> testdata) throws Throwable {
		try {
				String AddNewUserNameBtn = testdata.get("Name").toString();
			    String AddNewUserEmailBtn = testdata.get("Email").toString();
			    String AddNewUserPhoneNumberBtn = testdata.get("Phonenumber").toString();
		...
		public void Add_new_user_page_Invalid_Email_Format(Map<Object,Object> testdata) throws Throwable {
		try {
		...
		public void Add_new_user_page_Invalid_Email_Format_missing_domain(Map<Object,Object> testdata) throws Throwable {
		try {
